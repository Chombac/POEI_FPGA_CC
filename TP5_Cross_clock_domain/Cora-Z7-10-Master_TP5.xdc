...
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {V_Led_A[0]}]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports {V_Led_B[1]}]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports {V_Led_B[2]}]
